package com.yamunaque.infraccionservice.config;
...
public class WebServiceConfig {
	...
	//localhost:8081/ws/infracciones.wsdl
	...
	public DefaultWsdl11Definition defaultWsdl11Definition(XsdSchema infraccionesSchema) {
	    ...
	    wsdl11Definition.setTargetNamespace("http://www.uss.com/infraccionservice");
